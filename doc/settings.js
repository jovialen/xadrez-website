...
(function () {
	...
	function buildSettingsPage() {
		...
		const settings = [
			{ name: 'Use system theme', js_name: 'use-system-theme', default: true },
			{ name: 'Theme', js_name: 'theme', default: 'light', options: themes },
			{
			...
			{ name: 'Show line numbers on code examples', js_name: 'line-numbers', default: false },
			{ name: 'Disable keyboard shortcuts', js_name: 'disable-shortcuts', default: false }
		];
